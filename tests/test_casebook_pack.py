"""Regression checks for the ember-rel-runbook-loom casebook."""
...
from casebook.harness import assert_expected, ember_rel_runbook_loom_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(ember_rel_runbook_loom_summary(), assert_expected())
